...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/main.css":
/*!************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/styles/main.css ***!
  \************************************************************************************************/
...
var _Landing = __webpack_require__(/*! ./components/Landing */ "./src/components/Landing.js");
...
var _NoteForm = __webpack_require__(/*! ./NoteForm */ "./src/components/NoteForm.js");

var _NoteForm2 = _interopRequireDefault(_NoteForm);

var _NoteList = __webpack_require__(/*! ./NoteList */ "./src/components/NoteList.js");

var _NoteList2 = _interopRequireDefault(_NoteList);

var _NoteItem = __webpack_require__(/*! ./NoteItem */ "./src/components/NoteItem.js");
...
var Dashboard = function (_React$Component) {
  ...
  _createClass(Dashboard, [{
    ...
    value: function addNote(note) {
      var newArray = this.state.notesList;
      newArray.push(note);
    ...
    value: function removeNote(id) {
      var deletingNote = this.state.notesList.find(function (note) {
        return note.id === id;
      });
      var objIndex = this.state.notes.indexOf(deletingObject);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_NoteForm2.default, { newObject: this.addNotes }),
        _react2.default.createElement(_NoteList2.default, { notes: this.state.notesList, removeObj: this.removeNote })
      );
    }
  }]);
...
var NoteForm = function (_React$Component) {
  ...
  function NoteForm(props) {
    ...
    _this.titleInput = _this.titleInput.bind(_this);
    _this.contentInput = _this.contentInput.bind(_this);
  ...
  _createClass(NoteForm, [{
    key: 'titleInput',
    value: function titleInput(event) {
    ...
    value: function contentInput(event) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { onChange: this.titleInput, type: 'text', placeholder: 'Title' }),
          _react2.default.createElement('textarea', { onChange: this.contentInput }),
          _react2.default.createElement(
            'button',
            { type: 'submit' },
            'Add Note Object'
...
var NoteItem = function (_React$Component) {
  ...
  function NoteItem(props) {
    ...
    var _this = _possibleConstructorReturn(this, (NoteItem.__proto__ || Object.getPrototypeOf(NoteItem)).call(this, props));
  ...
  _createClass(NoteList, [{
    ...
    value: function showNotes() {
      return this.props.notes.map(function (note) {
        return _react2.default.createElement(Note, { key: note.id, id: note.id, content: note.content });
      });
    }
  }, {
    key: 'render',
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/sass-loader/lib/loader.js!./main.css */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/main.css");
