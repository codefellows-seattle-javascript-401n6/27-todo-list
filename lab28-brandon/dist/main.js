...
/***/ "./node_modules/uuidv4/dist/uuidv4.js":
/*!********************************************!*\
  !*** ./node_modules/uuidv4/dist/uuidv4.js ***!
  \********************************************/
/*! no static exports found */
...
var sha1 = __webpack_require__(/*! sha-1 */ "./node_modules/sha-1/sha1.js");
...
var _Landing = __webpack_require__(/*! ./components/Landing.jsx */ "./src/components/Landing.jsx");
...
var _uuidv = __webpack_require__(/*! uuidv4 */ "./node_modules/uuidv4/dist/uuidv4.js");

var _uuidv2 = _interopRequireDefault(_uuidv);

var _NoteItem = __webpack_require__(/*! ./NoteItem.jsx */ "./src/components/NoteItem.jsx");

var _NoteItem2 = _interopRequireDefault(_NoteItem);

var _NoteList = __webpack_require__(/*! ./NoteList.jsx */ "./src/components/NoteList.jsx");

var _NoteList2 = _interopRequireDefault(_NoteList);

var _NoteCreateForm = __webpack_require__(/*! ./NoteCreateForm.jsx */ "./src/components/NoteCreateForm.jsx");
...
var Dashboard = function (_React$Component) {
  ...
  _createClass(Dashboard, [{
    key: 'addTask',
    value: function addTask(taskObj) {
    ...
    value: function removeTask(id) {
      ...
      var taskToDelete = this.state.tasks.find(function (task) {
        console.log('task deleted', task.id);
        return task.id === id;
      });
      var taskIndex = this.state.tasks.indexOf(taskToDelete);
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_NoteCreateForm2.default, { addTask: this.addTask }),
        _react2.default.createElement(_NoteList2.default, { tasks: this.state.tasks, removeTask: this.removeTask })
      );
    }
  }]);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          null,
          'Welcome to my make a list app!!! Please click on the Todo-list tab to start making your list.'
        )
      );
    }
  }]);
...
/***/ "./src/components/NoteCreateForm.jsx":
/*!*******************************************!*\
  !*** ./src/components/NoteCreateForm.jsx ***!
  \*******************************************/
/*! no static exports found */
...
var NoteCreateForm = function (_React$Component) {
  _inherits(NoteCreateForm, _React$Component);

  function NoteCreateForm(props) {
    _classCallCheck(this, NoteCreateForm);

    var _this = _possibleConstructorReturn(this, (NoteCreateForm.__proto__ || Object.getPrototypeOf(NoteCreateForm)).call(this, props));
  ...
  _createClass(NoteCreateForm, [{
    ...
    key: 'updateContent',
    value: function updateContent(ev) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', value: this.state.content,
          placeholder: 'content',
...
exports.default = NoteCreateForm;
  ...
  _createClass(NoteList, [{
    ...
    value: function list() {
      ...
      return this.props.tasks.map(function (task) {
        return _react2.default.createElement(_NoteItem2.default, { key: task.id, id: task.id, title: task.id, content: task.id, removeTask: _this2.props.removeTask });
      });
    }
  }, {
    key: 'render',
